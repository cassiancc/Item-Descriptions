...
### Added
- Descriptions for 1.21.9's Mannequins.
- Port to 25w45a.

### Changed
- Internal changes including Loom 1.12 and proper version requirements in `neoforge.mods.toml`.
...
- Enchantment Descriptions are now visible when using [Quark](https://modrinth.com/mod/quark)'s Matrix Enchanting feature.
- Mod name tooltip now better handles mod IDs with spaces.
- Mod name tooltip now respects `getCreatorModId` (NeoForge) and `getCreatorNamespace` (Fabric 1.21.1 and above).
- Mod name tooltip now has a config for italicization.
...
### Fixed
- Crash when running with Java 17.

## [2.2.1] - 2025-05-07

### Fixed
- Wrapping issues on Forge.
