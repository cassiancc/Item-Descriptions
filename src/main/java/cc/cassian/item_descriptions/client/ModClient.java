...
public class ModClient {
    ...
    public static final Identifier BLOCK_DESCRIPTIONS = new Identifier(MOD_ID, "block_descriptions");
    public static final Identifier ENTITY_DESCRIPTIONS = new Identifier(MOD_ID, "entity_descriptions");
