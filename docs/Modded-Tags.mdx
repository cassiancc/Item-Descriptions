...
For example, if I wanted to add a description to Torch Levers from [Pyrite](https://modrinth.com/mod/pyrite), I would add the following entry to [Infinite Dimensions's language file](https://github.com/cassiancc/Pyrite/blob/1.20.1/common/src/main/resources/assets/pyrite/lang/en_us.json).
